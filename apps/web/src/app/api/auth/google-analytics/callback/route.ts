...
export async function GET(request: NextRequest) {
  try {
    ...
    const redirectUrl = clientData?._id 
      ? `${process.env.NEXTAUTH_URL}/admin/clients/${clientData._id}?success=google_analytics_connected&properties=${properties.length}`
      : `${process.env.NEXTAUTH_URL}/admin/clients?success=google_analytics_connected`;
