...
export default function PortalHome({ clientSlug }: PortalHomeProps) {
      ...
      <div>
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          <QuickActionCard
            ...
            icon={BarChart3}
            href={`/portal/${clientSlug}/dashboard`}
            color="text-blue-500"
          />
          <QuickActionCard
            title="Analytics"
            ...
            icon={TrendingUp}
            href={`/portal/${clientSlug}/analytics`}
            color="text-green-500"
          />
          <QuickActionCard
            title="Campanhas"
            ...
            icon={Target}
            href={`/portal/${clientSlug}/campanhas`}
            color="text-purple-500"
          />
          <QuickActionCard
            title="Gráficos"
      ...
      <div>
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          ...
          <QuickActionCard
            ...
            icon={Settings}
            href={`/portal/${clientSlug}/configuracoes`}
            color="text-gray-500"
          />
        </div>
      </div>
