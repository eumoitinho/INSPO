...
interface PortalConfiguracoesProps {
  clientSlug: string
}
...
export default function PortalConfiguracoes({ clientSlug }: PortalConfiguracoesProps) {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const response = await fetch(`/api/portal/${settings._id}/settings`, {
        method: 'PUT',
        headers: {
